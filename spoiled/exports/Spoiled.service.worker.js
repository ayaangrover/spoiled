...
/** @type {string} */
const CACHE_VERSION = '1751056317|827972752';
/** @type {string} */
const CACHE_PREFIX = 'Spoiled-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Spoiled.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Spoiled.html","Spoiled.js","Spoiled.offline.html","Spoiled.icon.png","Spoiled.apple-touch-icon.png","Spoiled.audio.worklet.js","Spoiled.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["Spoiled.wasm","Spoiled.pck"];
